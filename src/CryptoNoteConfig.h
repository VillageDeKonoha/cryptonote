...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x3fe192;
...
const char     CRYPTONOTE_NAME[]                             = "ryo";
...
const int      P2P_DEFAULT_PORT                              = 19225;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 19226;
